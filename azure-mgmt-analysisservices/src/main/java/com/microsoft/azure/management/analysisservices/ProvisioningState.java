...
public final class ProvisioningState {
    ...
    public static final ProvisioningState PAUSED = new ProvisioningState("Paused");

    /** Static value Suspended for ProvisioningState. */
    public static final ProvisioningState SUSPENDED = new ProvisioningState("Suspended");
    ...
    public static final ProvisioningState SUSPENDING = new ProvisioningState("Suspending");

    /** Static value Pausing for ProvisioningState. */
    public static final ProvisioningState PAUSING = new ProvisioningState("Pausing");

    /** Static value Resuming for ProvisioningState. */
    public static final ProvisioningState RESUMING = new ProvisioningState("Resuming");

    /** Static value Preparing for ProvisioningState. */
    public static final ProvisioningState PREPARING = new ProvisioningState("Preparing");

    /** Static value Scaling for ProvisioningState. */
    public static final ProvisioningState SCALING = new ProvisioningState("Scaling");
